...
<sup>*1 While deforestation refers to the entire removal of forest, degradation means that the forest still exists but with reduced functions*</sup> 
...
### <!--{ layers='[{"type":"Tile","properties":{"id":"osm"},"source":{"type":"OSM"}}]' center=[0,90] zoom="1" }-->

**ZOOM HERE TO NORTHERN LATITUDES, Show this dataset: https://www.eodashboard.org/explore?search=Global%3A+NDVI&x=2576417.3427&y=4987690.51061&z=3.48852&poi=World-E10e** 
...
### <!--{ layers='[{"type":"Tile","properties":{"id":"osm"},"source":{"type":"OSM"}}]' center=[0,90] zoom="1" }-->
**ZOOM HERE TO AMAZON, Show the NASA Evapotranspiration dataset**
...
**Load the Sentinel-1 Amazonas dataset**
...
**The Giant sequoias in California**
...
---> Zoom to this dataset https://www.eodashboard.org/explore?search=World%3A+Secondary+forest+growth+%28CCI+RECCAP2%29&x=-3771417.60562&y=-873093.0997&z=4.13747&poi=World-RECCAP2_5
