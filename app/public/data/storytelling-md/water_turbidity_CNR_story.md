...
The Po River's flow rate at the monitoring station fluctuated between 104 and 8011 cubic meters per second during the study period, averaging 1164 m³/s. Six discharge were identified for analysis, namely: 'dry conditions' (<500 m³/s), 'low flow' (500-1000 m³/s), 'moderate flow' (1000-2000 m³/s), 'high flow' (2000-4000 m³/s), 'flood stage' (4000-6000 m³/s), and 'extreme flood' (>6000 m³/s). From the collected imagery, 7 fit in the 'dry conditions' category, 19 to 'low flow', 11 to 'moderate flow', and 5 to 'high flow' events (Figure 1).
