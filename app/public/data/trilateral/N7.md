...
Similarly, by comparing SAR image data before and after COVID-19 lockdowns, NASA researchers have produced “Slowdown Proxy Maps,” which reveal where vehicle and construction activity has slowed during COVID-19 shutdowns. These slower areas are shown in the blue-shaded regions on the map.
...
The Slowdown Proxy Maps will also be able to track when and where activity begins to increase as COVID-19 restrictions ease. 
