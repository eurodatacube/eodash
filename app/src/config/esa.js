  ...
  },
  {
    ...
    properties: {
      indicatorObject: {
        ...
        time: availableDates.N3_CUSTOM.reverse(),
        inputData: [''],
        display: {
          baseUrl: `https://shservices.mundiwebservices.com/ogc/wms/${shConfig.shInstanceId}`,
  ...
  },
  {
    ...
    properties: {
      indicatorObject: {
        ...
        time: availableDates.N3_CUSTOM_TSMNN.reverse(),
        inputData: [''],
        display: {
          baseUrl: `https://shservices.mundiwebservices.com/ogc/wms/${shConfig.shInstanceId}`,
          name: 'Water Quality Index',
  ...
  },
  {
    properties: {
      indicatorObject: {
        ...
        aoi: null,
        aoiID: 'W2',
        time: availableDates.E12C_NEW_MOTORWAY.reverse(),
        inputData: [''],
  ...
  },
  {
    properties: {
      indicatorObject: {
        ...
        aoi: null,
        aoiID: 'W3',
        time: availableDates.E12D_NEW_PRIMARYROADS.reverse(),
        inputData: [''],
        yAxis: 'Number of trucks detected',
        display: {
          baseUrl: `https://shservices.mundiwebservices.com/ogc/wms/${shConfig.shInstanceId}`,
  ...
  },
  {
    ...
    properties: {
      indicatorObject: {
        ...
        lastColorCode: null,
        time: availableDates['ICEYE-E3'].reverse(),
        inputData: [''],
        display: {
          baseUrl: `https://shservices.mundiwebservices.com/ogc/wms/${shConfig.shInstanceId}`,
          layers: 'ICEYE-E3',
  ...
  },
  {
    ...
    properties: {
      indicatorObject: {
        ...
        lastColorCode: null,
        time: availableDates['ICEYE-E11'].reverse(),
        inputData: [''],
        display: {
          baseUrl: `https://shservices.mundiwebservices.com/ogc/wms/${shConfig.shInstanceId}`,
          layers: 'ICEYE-E11',
  ...
  },
  {
    ...
    properties: {
      indicatorObject: {
        ...
        lastColorCode: null,
        time: availableDates['ICEYE-E11A'].reverse(),
        inputData: [''],
        display: {
          baseUrl: `https://shservices.mundiwebservices.com/ogc/wms/${shConfig.shInstanceId}`,
          layers: 'ICEYE-E11A',
  ...
  },
  {
    ...
    properties: {
      indicatorObject: {
        ...
        lastColorCode: null,
        time: availableDates['ICEYE-E12B'].reverse(),
        inputData: [''],
        display: {
          baseUrl: `https://shservices.mundiwebservices.com/ogc/wms/${shConfig.shInstanceId}`,
          layers: 'ICEYE-E12B',
