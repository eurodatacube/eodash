    ...
    properties: {
      indicatorObject: {
        ...
        display: [{
          ...
          bounds: latLngBounds(latLng([33, -12]), latLng([66, 10.5])),
        }, {
          ...cmemsDisplay,
