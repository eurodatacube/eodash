    ...
    properties: {
      indicatorObject: {
        ...
        display: {
          ...
          legendUrl: 'legends/esa/W6-NASAPopulation.png',
          minZoom: 1,
          maxZoom: 7,
        },
      },
    ...
    properties: {
      indicatorObject: {
        ...
        display: {
          ...
          legendUrl: 'legends/esa/CDS34.png',
          minZoom: 1,
          maxZoom: 13,
          dateFormatFunction: (date) => DateTime.fromISO(date).toFormat('yyyy-MM-dd'),
          customAreaIndicator: true,
    ...
    properties: {
      indicatorObject: {
        ...
        display: {
          ...
          legendUrl: 'legends/esa/SO2-N1.png',
          minZoom: 1,
          maxZoom: 13,
          dateFormatFunction: (date) => DateTime.fromISO(date).toFormat('yyyy-MM-dd'),
          customAreaIndicator: true,
