    ...
    properties: {
      indicatorObject: {
        ...
        featureFilters: {
          ...
          filters: [
            { id: 'al', description: 'other glued wood products (dou or trilam)' },
            { id: 'bsh', description: 'laminated wood' },
            { id: 'bu', description: 'production of beech' },
            { id: 'ei', description: 'production of oak ' },
            { id: 's', description: 'other' },
            { id: 'b', description: 'log band saw' },
            { id: 'g', description: 'frame saw ' },
            { id: 'i', description: 'impregnation ' },
            { id: 'l', description: 'laminating line' },
            { id: 'k', description: 'finger jointing' },
            { id: 'n', description: 'double cutting circular saw' },
            { id: 'p', description: 'profiler' },
            { id: 't', description: 'drying chamber' },
            { id: 'tb', description: 'band re-saw' },
            { id: 'hw', description: 'produces planed goods' },
            { id: 'veh', description: 'ordinary member of the Association of the European Planing Mill Industry' },
            { id: 'fi_ta', description: 'production of spruce/fir' },
            { id: 'la', description: 'production of larch' },
            { id: 'ki', description: 'production of pine' },
            { id: 'mh', description: 'CE certified sawmills which manufacture high-quality construction solid timber without gluing and finger joint ' },
            { id: 'ls', description: 'this sawmill also takes subcontracting orders ' },
          ],
        },
        display: [
          {
