  ...
  */
  {
    ...
    properties: {
      indicatorObject: {
        ...
        aoi: null,
        aoiID: 'AT',
        time: getMinuteIntervals('2022-12-01T00:00:00Z', '2022-12-31T23:30:00Z', 30),
        inputData: [''],
        yAxis: '',
        highlights: [
          {
        ...
        queryParameters: {
          sourceLayer: 'trajectories_on_edges_austria_december',
        ...
        display: {
          ...
          id: 'trajectories_on_edges_austria_december',
