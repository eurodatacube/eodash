        ...
        cogFilters: {
          ...
          filters: {
            selectedBand: {
              ...
              type: 'select',
              entries: [
                { text: 'Basal area', value: 1, range: [0, 100] },
                { text: 'Broadleaf proportion', value: 2, range: [0, 100] },
                { text: 'Conifer proportion', value: 4, range: [0, 100] },
                { text: 'Tree diameter', value: 3, range: [0, 70] },
                { text: 'Tree height', value: 5, range: [0, 2500] },
                { text: 'Growing stock volume', value: 6, range: [0, 2000] },
              ],
              value: 1,
            },
            visualization: {
