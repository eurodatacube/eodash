        ...
        display: [
          {
            flatStyle: [
              {
                filter: ['==', ['get', 'sawmill_data'], '000001110011000000100'],
                style: {
                  'circle-radius': 10,
            ...
            layerName: 'geodb_debd884d-92f9-4979-87b6-eadef1139394:GTIF_sawmills',
            protocol: 'geoserverTileLayer',
            name: 'Sawmills',
            visible: true,
            selection: {
            ...
            filters: {
              sawmillType: {
                values: {
                  AL: 'other glued wood products (dou or trilam)',
                  BSH: 'laminated wood',
                  BU: 'production of beech',
                  EI: 'production of oak ',
                  S: 'other',
                  B: 'log band saw',
                  G: 'frame saw ',
                  I: 'impregnation ',
                  L: 'laminating line',
                  K: 'finger jointing',
                  N: 'double cutting circular saw',
                  P: 'profiler',
                  T: 'drying chamber',
                  TB: 'band re-saw',
                  HW: 'produces planed goods',
                  VEH: 'ordinary member of the Association of the European Planing Mill Industry',
                  FI_TA: 'production of spruce/fir',
                  LA: 'production of larch',
                  KI: 'production of pine',
                  MH: 'CE certified sawmills which manufacture high-quality construction solid timber without gluing and finger joint ',
                  LS: 'this sawmill also takes subcontracting orders ',
                },
              },
            },
          },
