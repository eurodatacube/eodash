    ...
    properties: {
      indicatorObject: {
        ...
        display: {
          ...
          legendUrl: 'eodash-data/data/no2Legend-monthly-nasa.png',
    ...
    properties: {
      indicatorObject: {
        ...
        display: {
          ...
          maxZoom: 10,
          maxMapZoom: 10,
          url: 'https://ejd872yh78.execute-api.us-east-1.amazonaws.com/cog/tiles/WebMercatorQuad/{z}/{x}/{y}?{time}&resampling_method=bilinear&rescale=-1e14,37e14&bidx=1&colormap_name=reds',
          name: 'NO2 OMI Annual',
          dateFormatFunction: (date) => `url=${date[1]}`,
          labelFormatFunction: (date) => DateTime.fromISO(date[0]).toFormat('yyyy'),
          legendUrl: 'eodash-data/data/no2Legend-yearly-nasa.png',
        },
      },
    },
  },
