...
export const globalIndicators = [
  ...
  //         maxNativeZoom: 18,
  //         opacity: 1,
  //         url: 'https://8ib71h0627.execute-api.us-east-1.amazonaws.com/v1/{z}/{x}/{y}@1x?url=s3://covid-eo-data/rpm/rpm-li.cog.tif&resampling_method=bilinear&bidx=1%2C2%2C3%24',
  //         name: 'Recovery Proxy Maps',
  //         attribution: '{ <a href="https://eodashboard.org/terms_and_conditions" target="_blank">Use of this data is subject to Articles 3 and 8 of the Terms and Conditions</a> }',
  //         // legendUrl: 'data/trilateral/N8-legend.png',
  //         disableCompare: true,
  ...
  //         maxNativeZoom: 18,
  //         opacity: 1,
  //         url: 'https://8ib71h0627.execute-api.us-east-1.amazonaws.com/v1/{z}/{x}/{y}@1x?url=s3://covid-eo-data/rpm/rpm-mb.cog.tif&resampling_method=bilinear&bidx=1%2C2%2C3%24',
  //         name: 'Recovery Proxy Maps',
  //         attribution: '{ <a href="https://eodashboard.org/terms_and_conditions" target="_blank">Use of this data is subject to Articles 3 and 8 of the Terms and Conditions</a> }',
  //         // legendUrl: 'data/trilateral/N8-legend.png',
  //         disableCompare: true,
  ...
  //         maxNativeZoom: 18,
  //         opacity: 1,
  //         url: 'https://8ib71h0627.execute-api.us-east-1.amazonaws.com/v1/{z}/{x}/{y}@1x?url=s3://covid-eo-data/rpm/rpm-st.cog.tif&resampling_method=bilinear&bidx=1%2C2%2C3%24',
  //         name: 'Recovery Proxy Maps',
  //         attribution: '{ <a href="https://eodashboard.org/terms_and_conditions" target="_blank">Use of this data is subject to Articles 3 and 8 of the Terms and Conditions</a> }',
  //         // legendUrl: 'data/trilateral/N8-legend.png',
  //         disableCompare: true,
  ...
  //         maxNativeZoom: 18,
  //         opacity: 1,
  //         url: 'https://8ib71h0627.execute-api.us-east-1.amazonaws.com/v1/{z}/{x}/{y}@1x?url=s3://covid-eo-data/rpm/rpm-sp.cog.tif&resampling_method=bilinear&bidx=1%2C2%2C3%24',
  //         name: 'Recovery Proxy Maps',
  //         attribution: '{ <a href="https://eodashboard.org/terms_and_conditions" target="_blank">Use of this data is subject to Articles 3 and 8 of the Terms and Conditions</a> }',
  //         // legendUrl: 'data/trilateral/N8-legend.png',
  //         disableCompare: true,
  ...
  //         maxNativeZoom: 18,
  //         opacity: 1,
  //         url: 'https://8ib71h0627.execute-api.us-east-1.amazonaws.com/v1/{z}/{x}/{y}@1x?url=s3://covid-eo-data/rpm/rpm-sg.cog.tif&resampling_method=bilinear&bidx=1%2C2%2C3%24',
  //         name: 'Recovery Proxy Maps',
  //         attribution: '{ <a href="https://eodashboard.org/terms_and_conditions" target="_blank">Use of this data is subject to Articles 3 and 8 of the Terms and Conditions</a> }',
  //         // legendUrl: 'data/trilateral/N8-legend.png',
  //         disableCompare: true,
