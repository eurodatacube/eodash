...
export const globalIndicators = [
  {
    properties: {
      indicatorObject: {
        ...
        City: 'World',
        'Site Name': 'global',
        Description: 'Air Quality (NO2) - ESA',
        'Indicator code': 'N1',
  ...
  },
  {
    properties: {
      indicatorObject: {
        ...
        City: 'World',
        'Site Name': 'global',
        Description: 'Air Quality (NO2) - NASA',
        'Indicator code': 'N1NASA',
        'Indicator Value': ['normal'],
        'Indicator Name': 'Air Quality (NO2) - NASA',
        'Sub-AOI': {
          type: 'FeatureCollection',
          features: [],
        },
  ...
  },
  {
    properties: {
      indicatorObject: {
        ...
        City: 'World',
        'Site Name': 'global',
        Description: 'Population - NASA',
        'Indicator code': 'NASAPopulation',
        'Indicator Value': ['normal'],
        'Indicator Name': 'Population - NASA',
        'Sub-AOI': {
          type: 'FeatureCollection',
          features: [],
        },
  ...
  },
  {
    ...
    properties: {
      ...
      indicatorObject: {
        ...
        'Indicator Value': ['normal'],
        'Indicator Name': 'Volume of Activity',
        'Color code': ['BLUE'],
