...
export const globalIndicators = [
  {
    properties: {
      indicatorObject: {
        ...
        City: 'World',
        'Site Name': 'global',
        Description: 'Air Quality (TROPOMI) - NO2',
        'Indicator code': 'N1',
  ...
  },
  {
    properties: {
      indicatorObject: {
        ...
        City: 'World',
        'Site Name': 'global',
        Description: 'Air Quality (OMI) - NO2',
        'Indicator code': 'N1',
        'Indicator Value': ['normal'],
        'Indicator Name': 'NO2 Concentration',
        'Sub-AOI': {
        ...
        display: {
          ...
          maxNativeZoom: 6,
          opacity: 0.7,
          url: 'https://h4ymwpefng.execute-api.us-east-1.amazonaws.com/v1/{z}/{x}/{y}@1x.png?url=s3://covid-eo-data/OMNO2d_HRM/OMI_trno2_0.10x0.10_{time}_Col3_V4.nc.tif&resampling_method=bilinear&bidx=1&rescale=0%2C1.4e16&color_map=reds',
  ...
  },
  {
    properties: {
      indicatorObject: {
        ...
        City: 'World',
        'Site Name': 'global',
        Description: 'Air Quality (OMI) - CO2 (mean)',
        'Indicator code': 'N1',
        'Indicator Value': ['normal'],
        'Indicator Name': 'CO2 Concentration mean',
        'Sub-AOI': {
          type: 'FeatureCollection',
          features: [],
        },
  ...
  },
  {
    properties: {
      indicatorObject: {
        ...
        City: 'World',
        'Site Name': 'global',
        Description: 'Air Quality (OMI) - CO2 (baseline)',
        'Indicator code': 'N1',
        'Indicator Value': ['normal'],
        'Indicator Name': 'CO2 Concentration baseline',
        'Sub-AOI': {
          type: 'FeatureCollection',
          features: [],
        },
        ...
        display: {
          ...
          maxNativeZoom: 6,
          opacity: 1,
          url: 'https://8ib71h0627.execute-api.us-east-1.amazonaws.com/v1/{z}/{y}/{x}@1x?url=s3://covid-eo-data/xco2/xco2_15day_baseline.{time}.tif&resampling_method=bilinear&bidx=1&rescale=0.0004%2C0.00042',
          name: 'Air Quality (NASA)',
          attribution: '{ Air Quality (NASA) }',
          dateFormatFunction: (date) => `${moment.utc(date, 'YYYY-MM-DD').format('YYYY_MM_DD')}`,
        },
  ...
  },
  {
    properties: {
      indicatorObject: {
        ...
        City: 'World',
        'Site Name': 'global',
        Description: 'Air Quality (OMI) - CO2 (diff)',
        'Indicator code': 'N1',
        'Indicator Value': ['normal'],
        'Indicator Name': 'CO2 Concentration diff',
        'Sub-AOI': {
          type: 'FeatureCollection',
          features: [],
        },
