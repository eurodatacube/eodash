  ...
  },
  {
    properties: {
      indicatorObject: {
        ...
        city: 'World',
        siteName: 'global',
        description: 'GRDI BUILT Constituent Raster',
        indicator: 'GRDI1',
        lastIndicatorValue: null,
        indicatorName: 'Global Gridded Relative Deprivation Index built-up area',
        subAoi: {
          type: 'FeatureCollection',
          features: [],
        },
        ...
        display: {
          ...
          maxZoom: 10,
          maxMapZoom: 10,
          url: 'https://ejd872yh78.execute-api.us-east-1.amazonaws.com/cog/tiles/WebMercatorQuad/{z}/{x}/{y}?{time}&resampling_method=bilinear&rescale=0.0,100.0&bidx=1&colormap_name=viridis',
          name: 'GRDI',
          dateFormatFunction: (date) => `url=${date[1]}`,
          labelFormatFunction: (date) => DateTime.fromISO(date[0]).toFormat('yyyy'),
  ...
  },
  {
    properties: {
      indicatorObject: {
        ...
        indicator: 'GRDI2',
        lastIndicatorValue: null,
        indicatorName: 'Global Gridded Relative Deprivation Index V1 raster',
        subAoi: {
          type: 'FeatureCollection',
          features: [],
        },
  ...
  },
  {
    properties: {
      indicatorObject: {
        ...
        city: 'World',
        siteName: 'global',
        description: 'GRDI SHDI Raster',
        indicator: 'GRDI3',
        lastIndicatorValue: null,
        indicatorName: 'GRDI SHDI Constituent Raster',
        subAoi: {
          type: 'FeatureCollection',
          features: [],
        },
  ...
  },
  {
    properties: {
      indicatorObject: {
        ...
        city: 'World',
        siteName: 'global',
        description: 'GRDI VNL Slope',
        indicator: 'GRDI4',
        lastIndicatorValue: null,
        indicatorName: 'GRDI VNL Slope Constituent Raster',
        subAoi: {
          type: 'FeatureCollection',
          features: [],
        },
