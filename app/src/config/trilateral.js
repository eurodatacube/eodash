  ...
  },
  {
    ...
    properties: {
      indicatorObject: {
        ...
        time: getWeeklyDates('2018-01-03', '2020-06-10').concat(['2020-08-01'], ['2020-08-08'], ['2020-08-15']).filter((item) => !['2018-02-07', '2018-02-28', '2018-03-21', '2018-05-23', '2018-06-06', '2018-06-13', '2018-08-15', '2018-08-29', '2018-10-10', '2018-10-31', '2018-12-05', '2019-02-06', '2019-02-20', '2019-04-17', '2019-04-24', '2019-05-01', '2019-06-05', '2019-06-26', '2019-07-03', '2019-07-10', '2019-07-17', '2019-09-18', '2019-10-16', '2019-12-04', '2020-01-22', '2020-02-12', '2020-03-11', '2020-04-22', '2020-05-27'].includes(item)),
        inputData: [''],
        display: {
          protocol: 'xyz',
          maxNativeZoom: 18,
  ...
  },
  {
    ...
    properties: {
      indicatorObject: {
        ...
        time: getWeeklyDates('2018-01-27', '2020-08-15').filter((item) => !['2018-02-10', '2018-03-03', '2018-05-05', '2018-05-26', '2018-07-14', '2018-07-28', '2018-09-15', '2018-09-22', '2018-10-13', '2018-11-03', '2018-12-08', '2019-06-15', '2019-07-06', '2019-07-13', '2019-07-20', '2019-09-21', '2019-10-19', '2020-01-25', '2020-06-27', '2020-07-04', '2020-07-11', '2020-07-25'].includes(item)),
        inputData: [''],
        display: {
          protocol: 'xyz',
          maxNativeZoom: 18,
  ...
  },
  {
    ...
    properties: {
      indicatorObject: {
        ...
        time: getWeeklyDates('2018-01-06', '2020-08-15').filter((item) => !['2018-01-20', '2018-02-10', '2018-03-03', '2018-10-13', '2018-12-08', '2018-12-22', '2019-01-26', '2019-06-15', '2019-08-31', '2019-09-21', '2020-01-25', '2020-03-28', '2020-05-16', '2020-06-27', '2020-07-04', '2020-07-11', '2020-07-25'].includes(item)),
        inputData: [''],
        display: {
          protocol: 'xyz',
          maxNativeZoom: 18,
  ...
  },
  {
    ...
    properties: {
      indicatorObject: {
        ...
        time: getWeeklyDates('2018-01-06', '2020-08-15').filter((item) => !['2018-02-10', '2018-03-03', '2018-03-24', '2018-05-26', '2018-06-09', '2018-06-16', '2018-07-14', '2018-08-18', '2018-09-01', '2018-10-13', '2018-11-03', '2018-12-08', '2019-02-09', '2019-02-23', '2019-04-20', '2019-04-27', '2019-05-04', '2019-06-08', '2019-06-29', '2019-07-06', '2019-07-13', '2019-07-20', '2019-09-21', '2019-10-19', '2019-12-07', '2020-01-25', '2020-02-15', '2020-03-14', '2020-04-25', '2020-05-30', '2020-06-20', '2020-06-27', '2020-07-04', '2020-07-11', '2020-07-18'].includes(item)),
        inputData: [''],
        display: {
          protocol: 'xyz',
          maxNativeZoom: 18,
  ...
  },
  {
    ...
    properties: {
      indicatorObject: {
        ...
        time: getWeeklyDates('2018-01-27', '2020-08-15').filter((item) => !['2018-02-10', '2018-03-03', '2018-05-05', '2018-05-26', '2018-07-14', '2018-07-28', '2018-09-15', '2018-09-22', '2018-10-13', '2018-11-03', '2018-12-08', '2019-06-01', '2019-06-15', '2019-07-06', '2019-07-13', '2019-07-20', '2019-09-21', '2019-10-19', '2020-01-25', '2020-06-13', '2020-06-27', '2020-07-04', '2020-07-11', '2020-07-25'].includes(item)),
        inputData: [''],
        display: {
          protocol: 'xyz',
          maxNativeZoom: 18,
  ...
  },
  {
    ...
    properties: {
      indicatorObject: {
        ...
        time: getWeeklyDates('2018-01-06', '2020-08-15').filter((item) => !['2018-01-20', '2018-02-10', '2018-03-03', '2018-10-13', '2018-12-08', '2018-12-22', '2019-01-26', '2019-06-15', '2019-06-29', '2019-08-31', '2019-09-21', '2020-01-25', '2020-03-28', '2020-05-16', '2020-06-27', '2020-07-04', '2020-07-11', '2020-07-25'].includes(item)),
        inputData: [''],
        display: {
          protocol: 'xyz',
          maxNativeZoom: 18,
    ...
    properties: {
      indicatorObject: {
        ...
        display: {
          ...
          maxNativeZoom: 18,
          opacity: 1,
          url: 'https://8ib71h0627.execute-api.us-east-1.amazonaws.com/v1/planet/{z}/{x}/{y}?date={time}&site=la',
    ...
    properties: {
      indicatorObject: {
        ...
        display: {
          ...
          maxNativeZoom: 18,
          opacity: 1,
          url: 'https://8ib71h0627.execute-api.us-east-1.amazonaws.com/v1/planet/{z}/{x}/{y}?date={time}&site=sf',
          name: 'Throughput at principal hub airports',
          attribution: '{ <a href="https://eodashboard.org/terms_and_conditions" target="_blank">Use of this data is subject to Articles 3 and 8 of the Terms and Conditions</a> }',
          dateFormatFunction: (date) => DateTime.fromISO(date).toFormat('yyyy_MM_dd'),
          features: {
    ...
    properties: {
      indicatorObject: {
        ...
        display: {
          ...
          maxNativeZoom: 18,
          opacity: 1,
          url: 'https://8ib71h0627.execute-api.us-east-1.amazonaws.com/v1/planet/{z}/{x}/{y}?date={time}&site=ny',
          name: 'Throughput at principal hub airports',
          attribution: '{ <a href="https://eodashboard.org/terms_and_conditions" target="_blank">Use of this data is subject to Articles 3 and 8 of the Terms and Conditions</a> }',
          dateFormatFunction: (date) => DateTime.fromISO(date).toFormat('yyyy_MM_dd'),
          features: {
    ...
    properties: {
      indicatorObject: {
        ...
        display: {
          ...
          maxNativeZoom: 18,
          opacity: 1,
          url: 'https://8ib71h0627.execute-api.us-east-1.amazonaws.com/v1/planet/{z}/{x}/{y}?date={time}&site=be',
          name: 'Throughput at principal hub airports',
          attribution: '{ <a href="https://eodashboard.org/terms_and_conditions" target="_blank">Use of this data is subject to Articles 3 and 8 of the Terms and Conditions</a> }',
          dateFormatFunction: (date) => DateTime.fromISO(date).toFormat('yyyy_MM_dd'),
          features: {
