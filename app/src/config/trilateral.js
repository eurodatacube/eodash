  ...
  },
  {
    ...
    properties: {
      indicatorObject: {
        ...
        colorCode: ['BLUE'],
        eoSensor: Array(6).fill(['Nightlights']),
        subAoi: {
          type: 'FeatureCollection',
          features: [{
            type: 'Feature',
  ...
  },
  {
    ...
    properties: {
      indicatorObject: {
        ...
        times: [['2020-01-01'], ['2020-01-08'], ['2020-01-15'], ['2020-01-22'], ['2020-01-29'], ['2020-02-05'], ['2020-02-12'], ['2020-02-19'], ['2020-02-26'], ['2020-03-04'], ['2020-03-11'], ['2020-03-18'], ['2020-03-25'], ['2020-04-01'], ['2020-04-08'], ['2020-04-15'], ['2020-04-22'], ['2020-04-29'], ['2020-05-06'], ['2020-05-13'], ['2020-05-20'], ['2020-05-27'], ['2020-06-03'], ['2020-06-10'], ['2020-06-17'], ['2020-06-24']],
        inputData: [''],
        display: {
          protocol: 'xyz',
          maxNativeZoom: 18,
  ...
  },
  {
    ...
    properties: {
      indicatorObject: {
        ...
        times: getWeeklyDates('2020-01-07', '2020-07-14'),
        inputData: [''],
        display: {
          ...defaultWMSDisplay,
          baseUrl: `https://shservices.mundiwebservices.com/ogc/wms/${shConfig.shInstanceIdTrilateral}`,
