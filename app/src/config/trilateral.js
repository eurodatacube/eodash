...
export const globalIndicators = [
  ...
  },
  {
    ...
    properties: {
      indicatorObject: {
        ...
        time: getWeeklyDates('2020-01-07', '2020-08-04'),
  ...
  {
    latlng: latLng([34.75,136.7]),
    id: 19989,
    properties: {
      indicatorObject: {
        dataLoadFinished: true,
        aoi: latLng([34.75,136.7]),
        id: 19989,
        aoiID: 'JP04',
        country: ['JP'],
        city: 'Nagoya',
        ...
        subAoi: {
          ...
          features: [{
            type: 'Feature',
            properties: {},
            geometry: wkt.read('POLYGON((136.2 34.25, 137.2 34.25, 137.2 35.25, 136.2 35.25, 136.2 34.25))').toJson(),
          }],
        },
        time: getWeeklyDates('2017-12-27', '2020-06-10').filter((item) => !['2020-05-27', '2020-04-22', '2020-03-11', '2020-02-12', '2020-01-22', '2019-12-04', '2019-10-16', '2019-09-18', '2019-07-17', '2019-07-10', '2019-07-03', '2019-06-26', '2019-06-05', '2019-05-01', '2019-04-24', '2019-04-17', '2019-02-20', '2019-02-06', '2018-12-05', '2018-10-31', '2018-10-10', '2018-08-29', '2018-08-15', '2018-06-13', '2018-06-06', '2018-05-23', '2018-03-21', '2018-02-28', '2018-02-07', '2017-12-27'].includes(item)),
        inputData: [''],
        display: {
          ...
          maxNativeZoom: 18,
          opacity: 1,
          url: 'https://8ib71h0627.execute-api.us-east-1.amazonaws.com/v1/{z}/{x}/{y}@1x?url=s3://covid-eo-data/oc3_chla_anomaly/anomaly-chl-na-{time}.tif&resampling_method=bilinear&bidx=1&color_map=rdbu_r',
          name: 'Water Quality Index',
          legendUrl: './data/trilateral/WaterQuality_legend_trilateral.png',
          attribution: '{ <a href="https://eodashboard.org/terms_and_conditions" target="_blank">Use of this data is subject to Articles 3 and 8 of the Terms and Conditions</a> }',
          dateFormatFunction: (date) => DateTime.fromISO(date).toFormat('yyyy_MM_dd'),
  ...
  {
    latlng: latLng([34.55,135.15]),
    id: 19988,
    properties: {
      indicatorObject: {
        dataLoadFinished: true,
        aoi: latLng([34.55,135.15]),
        id: 19988,
        aoiID: 'JP02',
        country: ['JP'],
        city: 'Osaka',
        ...
        subAoi: {
          ...
          features: [{
            type: 'Feature',
            properties: {},
            geometry: wkt.read('POLYGON((134.65 34.05, 135.65 34.05, 135.65 35.05, 134.65 35.05, 134.65 34.05))').toJson(),
          }],
        },
        time: getWeeklyDates('2017-12-27', '2020-06-10').filter((item) => !['2020-05-27', '2020-04-22', '2020-03-11', '2020-02-12', '2020-01-22', '2019-12-04', '2019-10-16', '2019-09-18', '2019-07-17', '2019-07-10', '2019-07-03', '2019-06-26', '2019-06-05', '2019-05-01', '2019-04-24', '2019-04-17', '2019-02-20', '2019-02-06', '2018-12-05', '2018-10-31', '2018-10-10', '2018-08-29', '2018-08-15', '2018-06-13', '2018-06-06', '2018-05-23', '2018-03-21', '2018-02-28', '2018-02-07', '2017-12-27'].includes(item)),
        inputData: [''],
        display: {
          ...
          maxNativeZoom: 18,
          opacity: 1,
          url: 'https://8ib71h0627.execute-api.us-east-1.amazonaws.com/v1/{z}/{x}/{y}@1x?url=s3://covid-eo-data/oc3_chla_anomaly/anomaly-chl-os-{time}.tif&resampling_method=bilinear&bidx=1&color_map=rdbu_r',
          name: 'Water Quality Index',
          legendUrl: './data/trilateral/WaterQuality_legend_trilateral.png',
          attribution: '{ <a href="https://eodashboard.org/terms_and_conditions" target="_blank">Use of this data is subject to Articles 3 and 8 of the Terms and Conditions</a> }',
          dateFormatFunction: (date) => DateTime.fromISO(date).toFormat('yyyy_MM_dd'),
  ...
  },
  {
    ...
    properties: {
      indicatorObject: {
        ...
        aoiID: 'US03SPM',
        country: ['US'],
        city: 'San Francisco - SPM',
        siteName: 'San Francisco',
        description: 'Water Quality Regional Maps',
        indicator: 'N3a2',
        lastIndicatorValue: 'normal',
        indicatorName: 'Water Quality Regional Maps (NASA) - SPM',
        lastColorCode: 'BLUE',
        eoSensor: null,
        subAoi: {
          type: 'FeatureCollection',
        ...
        time: [['2020-06-01'], ['2020-06-03'], ['2020-06-06'], ['2020-06-13'], ['2020-06-21'], ['2020-06-22'], ['2020-06-23'], ['2020-06-25'], ['2020-06-28'], ['2020-06-30'], ['2020-07-01'], ['2020-07-03']],
        inputData: [''],
        display: {
          protocol: 'xyz',
          maxNativeZoom: 18,
