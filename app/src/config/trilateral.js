  ...
  },
  {
    properties: {
      indicatorObject: {
        ...
        aoi: null,
        aoiID: 'W2',
        time: getMonthlyDates('2004-10-01', '2021-12-01'),
        inputData: [''],
        yAxis: 'NO2 [µmol/m²]',
        display: {
          customAreaIndicator: true,
  ...
  },
  {
    properties: {
      indicatorObject: {
        ...
        aoi: null,
        aoiID: 'W3',
        time: getMonthlyDates('2015-01-01', '2021-12-01'),
        inputData: [''],
        display: {
          protocol: 'xyz',
          maxNativeZoom: 6,
  ...
  },
  {
    ...
    properties: {
      indicatorObject: {
        ...
        time: getWeeklyDates('2020-01-01', '2021-12-22').filter((item) => !['2020-08-19', '2020-08-26'].includes(item)),
        inputData: [''],
        display: {
          protocol: 'xyz',
          maxNativeZoom: 18,
  ...
  },
  {
    properties: {
      indicatorObject: {
        ...
        aoi: null,
        aoiID: 'W6',
        time: getMonthlyDates('2020-01-28', '2021-11-28'),
        inputData: [''],
        display: {
          protocol: 'xyz',
          maxNativeZoom: 6,
