...
### <!--{ layers='[{"type":"Tile","properties":{"id":"osm"},"source":{"type":"OSM"}}]' center=[10,48] zoom="2" }-->
...
## <!--{ as="iframe" src="https://eodashboard.org/iframe?poi=W6-N6&embedMap=true&z=4.096465194002971&lat=30.63794819428159&lng=24.885345134708164" width="100%" height="500px" frameBorder="0" scroll="no" style="overflow:hidden" }-->
      `;
    },
  },
};
